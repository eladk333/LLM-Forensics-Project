...
DATASETS_TO_PROCESS = [
    {
        ...
        'estimated_total_tokens': 250_000_000_000, # Used strictly for the progress percentage
...
def generate_frequencies(config):
    ...
    while total_tokens < config['tokens_to_sample']: # This while true I just did it for testing.
