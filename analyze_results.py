...
# Maps model size -> subfolder name (different naming convention for 500M)
MODEL_FOLDER_MAP = {
    '7M':   'MinGPT_Checkpoints_7M',
    '30M':  'MinGPT_Checkpoints_30M',
    '124M': 'MinGPT_Checkpoints_124M',
    '500M': r'500M_Context1024',
}

# Frequency file — use OpenWebText since that's what 500M was trained on.
# If you want to compare older models on the same footing, keep this file.
# Switch back to wiki_token_frequencies.csv to use the old WikiText-103 frequencies.
FREQ_FILE_MAP = {
    '7M':   r'G:\My Drive\llm\wiki_token_frequencies.csv',
    '30M':  r'G:\My Drive\llm\wiki_token_frequencies.csv',
    '124M': r'G:\My Drive\llm\wiki_token_frequencies.csv',
    '500M': r'G:\My Drive\llm\openwebtext_token_frequencies.csv',
}
...
if __name__ == "__main__":
    ...
    for size in MODEL_SIZES:
        ...
        if not os.path.exists(feature_file):
            print(f"   Feature file not found at {feature_file}. Skipping.")
            continue
