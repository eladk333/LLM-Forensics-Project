...
N_LAYER = 4   # Increased from 6
N_HEAD  = 4   # Increased from 6
N_EMBD  = 128  # Increased from 384
BATCH_SIZE = 32 # Same for all models

# Paths - Updated to isolate the 3-epoch run
CHECKPOINT_FOLDER_PATH = os.path.join(os.getcwd(), 'data', 'models', '7M_wiki_3epoch') 
